...
public enum ExpressionType {
    ...
    DecimalModulusExpression(DecimalModulusExpression.class),
    DoubleModulusExpression(DoubleModulusExpression.class),
    LongModulusExpression(LongModulusExpression.class),
