...
public abstract class ModulusExpression extends ArithmeticExpression {
    ...
    protected Expression getMinuend() {
        return getDividendExpression();
    }

    protected Expression getSubtrahendExpression() {
        ...
        return new DecimalMultiplyExpression(Arrays.asList(
